...
import com.clover.fda.hellfire03.host.HostActivity;
...
public class MiqActivity extends ActionBarActivity {
    ...
    public void doInit(View view){
        Intent intend = new Intent(this, HostActivity.class);
        startActivity(intend);
        //Host.buildEftRequest(getApplicationContext(), ScMenu.STARTUP_MESSAGE);
    }
}
